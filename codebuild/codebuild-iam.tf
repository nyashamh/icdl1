resource "aws_iam_role" "icdl-codebuild-role" {
  name = "icdl-codebuild-role"
...
resource "aws_iam_role_policy" "CodeBuildBasePolicy-icdl-codebuild" {
  role = aws_iam_role.icdl-codebuild-role.name
  policy = <<POLICY
{
     "Version": "2012-10-17",
    "Statement": [
        ...
        },
        {
            ...
            "Resource": "arn:aws:ecr:eu-west-1:813260210012:repository/icdl-north-ecr"
        },
